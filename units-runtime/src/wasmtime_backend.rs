...
use crate::host_environment::{StandardHostEnvironment, create_standard_host_environment};
use crate::runtime_backend::{HostEnvironment, InstructionContext, InstructionResult, RuntimeBackend};
...
mod host_funcs {
    ...
    pub fn log_message(
        ...
        let host_env = caller.data().host_environment.lock()
...
impl WasmtimeRuntimeBackend {
    ...
    fn execute_module(
        ...
        let host_env = store.data().host_environment.lock()
